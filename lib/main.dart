...
// --- AJOUT : Import nécessaire pour accéder à Intl ---
...
import 'package:wink_manager/repositories/shop_repository.dart'; // <-- NOUVEL IMPORT
...
import 'package:wink_manager/providers/shop_provider.dart'; // <-- NOUVEL IMPORT
...
import 'package:wink_manager/services/shop_service.dart'; // <-- NOUVEL IMPORT
...
void main() async {
  ...
  // --- AJOUT : Définit la locale par défaut pour tout le package intl ---
  // Cela assure que DateFormat() utilisera 'fr_FR' même si on ne le précise pas explicitement.
      ...
      child: Consumer<AuthService>(
        builder: (context, authService, _) {
          return MaterialApp(
            ...
            // Configuration de la localisation Flutter
