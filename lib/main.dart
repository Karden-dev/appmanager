  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // (Corrigé pour ne plus passer OrderRepository à SyncService)
        ...
        // (Corrigé pour ne plus passer SyncService à OrderProvider)
      ...
      child: Consumer<AuthService>(
        builder: (context, authService, _) {
          return MaterialApp(
            ...
            // --- MODIFICATION : Logique de chargement au démarrage ---
            home: authService.isLoading
                // Pendant que tryAutoLogin() s'exécute
                ? const Scaffold(body: Center(child: CircularProgressIndicator()))
                // Une fois tryAutoLogin() terminé
