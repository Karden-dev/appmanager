  ...
  Widget build(BuildContext context) {
    return FutureBuilder<AdminOrder?>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text('Détails Cde #${order.id}'),
          ),
              ...
              children: [
                ...
                _buildSectionCard(
                  ...
                  children: [
                    ...
                    // --- Ligne Téléphone avec actions (Espacement et boutons stylisés) ---
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const SizedBox(width: 12),
          Text('Téléphone Client:', style: TextStyle(color: Colors.grey.shade700)),
          const SizedBox(width: 8),
          Expanded(
            child: Text(
              phoneNumber,
  ...
  Widget _buildStatusBadge(BuildContext context, AdminOrder order) {
    ...
    return Column(
      children: [
        ...
        // Affichage du montant reçu (si échec)
        if (order.status == 'failed_delivery' && order.articleAmount > 0) // Correction: utiliser articleAmount comme référence si amountReceived n'est pas dans AdminOrder
           Padding(
             ...
             child: Row(
               children: [
                 ...
                 const SizedBox(width: 8),
                 // TODO: Le modèle AdminOrder n'a pas 'amountReceived'. Utilisation de articleAmount en attendant.
                 Expanded(child: Text(_formatAmount(order.articleAmount), style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.orange))),
               ],
             ),
           ),
