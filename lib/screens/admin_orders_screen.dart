...
class _AdminOrdersScreenState extends State<AdminOrdersScreen> {
  ...
  AppBar _buildDefaultAppBar(BuildContext context, OrderProvider provider) {
    return AppBar(
      ...
      actions: [
        // --- MODIFIÉ : Remplacement de la Loupe et du Calendrier par la Cloche ---
        IconButton(
          icon: const Icon(Icons.notifications_none_outlined),
          tooltip: 'Notifications',
          onPressed: () {
            // TODO: Implémenter la logique d'affichage des notifications
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(content: Text('Écran de notifications (WIP)')),
            );
          },
        ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Ligne 2: Filtre Statut et Plage de Date (Corrigé avec Flex)
          Row(
            crossAxisAlignment: CrossAxisAlignment.center, 
            children: [
              Expanded(
                flex: 3, // Donne plus d'espace au statut
              ...
              Expanded(
                flex: 2, // Donne moins d'espace à la date
                child: Text(
