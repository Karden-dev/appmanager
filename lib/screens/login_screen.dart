...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // bool _rememberMe = false; // SUPPRIMÉ
  ...
  void _login() async {
    ...
    try {
      // **CORRECTION : Appel simplifié sans rememberMe**
      await Provider.of<AuthService>(context, listen: false).login(
        _phoneController.text.trim(),
        pin,
        // rememberMe: _rememberMe, // <-- Ligne supprimée
      );
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              // --- BLOC "Se souvenir de moi" SUPPRIMÉ ---
              // Remplacé par un simple Alignement pour "Code PIN oublié"
              Align(
