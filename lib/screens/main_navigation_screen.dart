...
// import 'package:wink_manager/screens/admin_orders_screen.dart'; // CORRECTION: Ligne supprimée (Résout l'erreur unused_import)
...
class _MainNavigationScreenState extends State<MainNavigationScreen> {
  ...
  static final List<Widget> _widgetOptions = <Widget>[
    const AdminOrdersScreen(), // Le symbole est maintenant résolu via un autre chemin
