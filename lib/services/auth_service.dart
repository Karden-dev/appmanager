...
class AuthService extends ChangeNotifier {
  ...
  Future<void> tryAutoLogin() async {
    ...
    final prefs = await SharedPreferences.getInstance(); // Ligne 50
  ...
  Future<void> login(String phoneNumber, String pin, {required bool rememberMe}) async {
    ...
    try {
      ...
      if (rememberMe) { 
          final prefs = await SharedPreferences.getInstance(); // Ligne 84
  ...
  Future<void> logout() async {
    _user = null;
    final prefs = await SharedPreferences.getInstance(); // Ligne 99
