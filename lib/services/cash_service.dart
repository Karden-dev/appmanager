...
class CashService {
  ...
  Future<void> confirmRemittance({
    ...
    // CORRECTION APPLIQUÉE : Utilisation de PUT au lieu de POST
    // Le backend attend une méthode PUT pour cette route.
    await _dio.put('/cash/remittances/confirm', data: {
      'deliverymanId': deliverymanId,
      'orderIds': orderIds,
      'paidAmount': amount,
      // Format de date aligné sur la version Web (YYYY-MM-DD)
