...
import 'package:flutter/material.dart'; // <-- L'importation CLÉ pour ColorScheme
...
class AppTheme {
  ...
  // *** NOUVEAU : Ajout de la couleur Warning pour les statuts d'alerte (0xFFffc107 est le jaune Bootstrap) ***
  static const Color warning = Color(0xFFffc107); // Couleur d'avertissement
