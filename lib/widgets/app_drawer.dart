...
import 'package:wink_manager/screens/admin_cash_screen.dart';
...
import 'package:wink_manager/screens/admin_shops_screen.dart';
import 'package:wink_manager/screens/main_navigation_screen.dart';
import 'package:wink_manager/screens/admin_dashboard_screen.dart';
import 'package:wink_manager/screens/admin_stock_validation_screen.dart'; // <-- AJOUT IMPORT
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              // Navigue vers l'écran principal et vide la pile de navigation
          ...
          // --- GESTION MARCHANDS ---
          ListTile(
            leading: const Icon(Icons.store, color: AppTheme.accentColor),
          ...
          ListTile(
            ...
            title: const Text('Validation Stocks'),
            onTap: () {
              Navigator.pop(context);
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (_) => const AdminStockValidationScreen()),
              );
            },
          ),
          // -------------------------------------
