...
import 'package:wink_manager/screens/main_navigation_screen.dart'; // Import écran principal
    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          const ListTile(
            leading: Icon(Icons.savings_outlined, color: Colors.grey),
            title: Text('Caisse (Bientôt)', style: TextStyle(color: Colors.grey)),
            enabled: false, 
          ),
