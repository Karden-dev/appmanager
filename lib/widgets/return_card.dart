            ...
            SizedBox(
              ...
              child: isPendingHub
                  ...
                  : (isConfirmedHub 
                      ...
                      : Container(padding: const EdgeInsets.symmetric(vertical: 4), child: const Center(child: Text('Suivi Terminé', style: TextStyle(color: AppTheme.success, fontWeight: FontWeight.w600))))
                    ),
            ),
          ],
        ),
