...
import 'package:wink_manager/services/auth_service.dart'; // <-- AJOUT IMPORT
...
class _ShopEditDialogState extends State<ShopEditDialog> {
  ...
  Future<void> _submit() async {
    ...
    // --- CORRECTION : Récupération de l'ID de l'admin connecté ---
    ...
    final shopData = {
      ...
      // --- CORRECTION : Envoi explicite de l'ID créateur ---
      'created_by': userId, 
    };
