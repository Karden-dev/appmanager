...
const getCashMetrics = async (req, res) => {
    try {
        // LECTURE ET PASSAGE DES PARAMÈTRES DE DATE AU SERVICE
        const { startDate, endDate } = req.query;
        ...
        res.status(500).json({ message: 'Erreur interne du serveur lors de la récupération des métriques de caisse.' });
    }
};
